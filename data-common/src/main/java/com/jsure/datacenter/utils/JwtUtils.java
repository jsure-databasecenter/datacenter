...
public class JwtUtils {
	...
	public static CheckResult validateJWT(String jwtStr) {
		...
		try {
			...
			checkResult.setErrCode(SystemErrorEnum.JWT_ERRCODE_EXPIRE.getErrorCode());
			checkResult.setErrMsg(SystemErrorEnum.JWT_ERRCODE_EXPIRE.getErrorDesc());
			checkResult.setSuccess(false);
		} catch (SignatureException e) {
			checkResult.setErrCode(SystemErrorEnum.JWT_ERRCODE_FAIL.getErrorCode());
			checkResult.setErrMsg(SystemErrorEnum.JWT_ERRCODE_FAIL.getErrorDesc());
			checkResult.setSuccess(false);
		} catch (Exception e) {
			checkResult.setErrCode(SystemErrorEnum.JWT_ERRCODE_FAIL.getErrorCode());
			checkResult.setErrMsg(SystemErrorEnum.JWT_ERRCODE_FAIL.getErrorDesc());
